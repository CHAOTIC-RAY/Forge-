    ...
    <div className="min-h-screen bg-[#F7F7F5] dark:bg-[#202020]">
      ...
      {user && !loading && (
        <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-6 pb-8 space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm mt-1 text-[#57534E] dark:text-[#CFCBC4]">
                  {legacyMode
                    ? 'You are connected to the legacy Firestore database. Open the calendar tab and use Export calendar to download your posts as JSON.'
                    : 'You are connected to the new Supabase database. Use Import calendar in the calendar tab to restore a schedule backup.'}
                </p>
          ...
          <div className="p-6 bg-white dark:bg-[#191919] rounded-[12px] border border-[#E9E9E7] dark:border-[#2F2F2F] space-y-4">
            {legacyMode ? (
              <>
                <p className="text-sm text-[#57534E] dark:text-[#CFCBC4]">
                  When you are ready to move to Supabase, export your calendar from the dashboard, sign out, then sign in with{' '}
                  <strong>Google — New database (Supabase)</strong> and import the backup there.
                </p>
                <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    ...
                    className="px-5 py-3 rounded-[10px] border border-[#E9E9E7] dark:border-[#2E2E2E] font-semibold hover:bg-[#F7F7F5] dark:hover:bg-[#202020] transition-colors"
                  >
      ...
      {!user && !loading && <Login redirectOnSignIn showDualDatabase />}
      {user && loading && (
