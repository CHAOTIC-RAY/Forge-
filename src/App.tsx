...
import { applyCustomTheme, DEFAULT_CUSTOM_THEME } from './lib/themeEngine';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (themePreset === 'custom') {
       try {
         const savedCustom = localStorage.getItem('forge_custom_theme_config');
         if (savedCustom) {
           applyCustomTheme(JSON.parse(savedCustom), isDarkMode);
         } else {
           // Fallback to default custom theme structure
           applyCustomTheme(DEFAULT_CUSTOM_THEME, isDarkMode);
         }
       } catch (e) {
         console.error("Error reading custom theme config", e);
       }
     } else {
      applyCustomTheme(null, isDarkMode);
    }
