...
export function AnalyticsTab({ setActiveTab }: { setActiveTab?: (tab: string) => void }) {
  ...
  return (
    <div className="flex flex-col bg-transparent relative">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex bg-[#F7F7F5] dark:bg-[#202020] p-1 rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-x-auto no-scrollbar max-w-full">
          <button 
            onClick={() => setViewMode('summary')}
            className={cn(
              "px-4 md:px-6 py-2 text-xs font-bold rounded-lg transition-all flex items-center gap-2 whitespace-nowrap",
              viewMode === 'summary' ? "bg-white dark:bg-[#191919] shadow-sm text-[#2383E2]" : "text-[#787774]"
            )}
          >
          ...
          <button 
            ...
            className={cn(
              "px-4 md:px-6 py-2 text-xs font-bold rounded-lg transition-all flex items-center gap-2 whitespace-nowrap",
              viewMode === 'timeline' ? "bg-white dark:bg-[#191919] shadow-sm text-[#2383E2]" : "text-[#787774]"
            )}
          >
          ...
          <button 
            ...
            className={cn(
              "px-4 md:px-6 py-2 text-xs font-bold rounded-lg transition-all flex items-center gap-2 whitespace-nowrap",
              viewMode === 'json' ? "bg-white dark:bg-[#191919] shadow-sm text-[#2383E2]" : "text-[#787774]"
            )}
          >
        ...
        {!hasAccounts && (
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 rounded-xl text-xs font-bold border border-amber-100 dark:border-amber-900/30 hover:bg-amber-100 transition-colors"
          >
      ...
      <div className="bg-white dark:bg-[#191919] rounded-2xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
        ...
        <div className="p-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-[#2383E2] hover:bg-blue-600 text-white rounded-2xl text-sm font-bold transition-all disabled:opacity-50 shadow-lg shadow-blue-500/20 active:scale-[0.98]"
          >
      ...
      <AnimatePresence mode="wait">
        {analytics && viewMode === 'summary' && (
          ...
          >
            {/* Summary */}
            <div className="md:col-span-12 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-2xl border border-blue-100 dark:border-blue-900/30 shadow-sm relative overflow-hidden">
            ...
            {/* Key Metrics Grid */}
            <div className="md:col-span-4 bg-white dark:bg-[#191919] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
              ...
              <div className="p-8 flex flex-col items-center justify-center text-center space-y-2">
                ...
                <p className="text-xs text-[#787774] font-medium uppercase tracking-wider">Best time to post</p>
              </div>
            </div>
            ...
            <div className="md:col-span-4 bg-white dark:bg-[#191919] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
              ...
              <div className="p-8 flex flex-col items-center justify-center text-center space-y-2">
                ...
                <p className="text-xs text-[#787774] font-medium uppercase tracking-wider">Avg. Interaction Rate</p>
              </div>
            </div>
            ...
            <div className="md:col-span-4 bg-white dark:bg-[#191919] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
              ...
              <div className="p-8 flex flex-col items-center justify-center text-center space-y-2">
                ...
                <p className="text-xs text-[#787774] font-medium uppercase tracking-wider">Total Growth Period</p>
              </div>
            </div>

            {/* Charts Row */}
            <div className="md:col-span-6 bg-white dark:bg-[#191919] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
              <div className="p-4 border-b border-[#E9E9E7] dark:border-[#2E2E2E] bg-[#F7F7F5] dark:bg-[#202020]">
                <h3 className="text-sm font-bold flex items-center gap-2">
              ...
              <div className="p-6 flex items-end justify-between gap-2 h-[150px]">
                {analytics.engagementOverTime.map((t, i) => (
                  <div key={i} className="flex flex-col items-center gap-2 flex-1 group relative">
                    ...
                    <div 
                      className="w-full bg-blue-500/20 group-hover:bg-blue-500/40 rounded-t-lg transition-all" 
                    ...
                    <span className="text-[8px] text-[#787774] truncate w-full text-center">{t.date}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Top Posts */}
            <div className="md:col-span-12 bg-white dark:bg-[#191919] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
              <div className="p-4 border-b border-[#E9E9E7] dark:border-[#2E2E2E] bg-[#F7F7F5] dark:bg-[#202020]">
                <h3 className="text-sm font-bold flex items-center gap-2">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {analytics.topPosts.map((post, idx) => (
                    <div key={idx} className="p-4 bg-[#F7F7F5] dark:bg-[#202020] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] hover:shadow-md transition-all">
            ...
            <div className="md:col-span-6 bg-white dark:bg-[#191919] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
              ...
              <div className="p-6 space-y-3">
                {analytics.formatSuggestions.map((suggestion, idx) => (
                  <div key={idx} className="flex items-start gap-3 p-3 bg-[#F7F7F5] dark:bg-[#202020] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E]">
                    <span className="flex-shrink-0 w-6 h-6 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center text-xs font-bold">
                      {idx + 1}
                    </span>
            ...
            <div className="md:col-span-6 bg-white dark:bg-[#191919] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
              ...
              <div className="p-6 grid grid-cols-2 gap-3">
                {analytics.hashtagPerformance.map((tag, idx) => (
                  <div key={idx} className="flex items-center justify-between p-2.5 bg-[#F7F7F5] dark:bg-[#202020] rounded-lg border border-[#E9E9E7] dark:border-[#2E2E2E]">
        ...
        {analytics && viewMode === 'timeline' && (
          <motion.div 
            ...
            className="space-y-6"
          >
            <div className="bg-white dark:bg-[#191919] rounded-xl border border-[#E9E9E7] dark:border-[#2E2E2E] overflow-hidden shadow-sm">
              <div className="p-4 border-b border-[#E9E9E7] dark:border-[#2E2E2E] bg-[#F7F7F5] dark:bg-[#202020]">
                <h3 className="text-sm font-bold flex items-center gap-2">
                  <Clock className="w-4 h-4 text-blue-500" />
                  Campaign Roadmap
                ...
                <div className="relative before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-0.5 before:bg-[#E9E9E7] dark:before:bg-[#2E2E2E]">
                  {analytics.engagementOverTime.map((item, idx) => (
                    <div key={idx} className="relative pl-10 pb-10 last:pb-0">
                      <div className="absolute left-0 top-1.5 w-6 h-6 rounded-full bg-blue-500 border-4 border-white dark:border-[#191919] shadow-sm z-10" />
        ...
        {analytics && viewMode === 'json' && (
          <motion.div 
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className="bg-[#1E1E1E] rounded-2xl border border-[#2E2E2E] overflow-hidden shadow-xl"
          >
