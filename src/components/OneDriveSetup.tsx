        ...
        <div className="p-6 space-y-6">
          {isConnected ? (
            <div className="space-y-6">
              <div className="p-4 bg-green-50 dark:bg-green-900/10 rounded-xl border border-green-100 dark:border-green-900/30 flex items-center gap-3">
              ...
              <button
                ...
                className="w-full py-3 bg-red-50 hover:bg-red-100 dark:bg-red-900/10 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400 rounded-xl font-bold transition-all border border-red-100 dark:border-red-900/30"
              >
                Disconnect OneDrive
              </button>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-[#F7F7F5] dark:bg-[#202020] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-xl text-sm outline-none focus:border-blue-500 transition-all"
                    />
                  </div>
                </div>
              ...
              <button
                ...
                className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl font-bold transition-all shadow-lg shadow-blue-500/20 mt-4"
              >
                Connect OneDrive
              </button>
            </div>
