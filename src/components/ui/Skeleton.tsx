...
export function HomeDashboardSkeleton() {
  return (
    <div
      className="flex-1 flex flex-col gap-5 md:gap-8 p-4 sm:p-6 md:p-8 lg:p-12 w-full"
      aria-busy="true"
  ...
  return (
    ...
    >
      {Array.from({ length: 3 }).map((_, i) => (
        <div
          key={i}
          className="flex flex-col rounded-2xl border border-[#E9E9E7] dark:border-[#2E2E2E] glass-card min-h-[240px] p-3 gap-2"
        >
