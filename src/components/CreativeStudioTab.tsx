...
export function CreativeStudioTab({ onSavePost, userId, activeBusiness }: CreativeStudioTabProps) {
  ...
  const renderWidgetUI = (widgetId: string) => {
        ...
        <div key={widgetId} className="bg-white dark:bg-[#1A1A1A] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-2xl overflow-hidden flex flex-col mb-6">
          <div className="p-5 border-b border-[#E9E9E7] dark:border-[#2E2E2E] bg-[#F7F7F5] dark:bg-[#2E2E2E] flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#787774] dark:text-[#9B9A97]">Powered by Travis</p>
              </div>
            </div>
            {activeWidget === null && (
              <button onClick={(e) => togglePinWidget(widgetId, e)} className="text-[#2665fd] p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-lg" title="Unpin Widget">
          ...
          <div className="p-6 space-y-6">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 bg-[#2665fd] hover:bg-blue-700 disabled:opacity-50 text-white rounded-xl text-sm font-bold transition-all active:scale-95"
            >
            ...
            {copyResult && (
              <div className="mt-6 bg-[#F7F7F5] dark:bg-[#2E2E2E] border border-[#E9E9E7] dark:border-[#3E3E3E] rounded-xl p-5">
                <h4 className="text-[10px] font-bold text-[#787774] dark:text-[#9B9A97] uppercase tracking-widest mb-4">Generated Result</h4>
        ...
        <div key={widgetId} className="bg-white dark:bg-[#1A1A1A] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-2xl overflow-hidden flex flex-col mb-6">
          <div className="p-5 border-b border-[#E9E9E7] dark:border-[#2E2E2E] bg-[#F7F7F5] dark:bg-[#2E2E2E] flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#787774] dark:text-[#9B9A97]">AIDA, PAS, BAB</p>
              </div>
            </div>
            {activeWidget === null && (
              <button onClick={(e) => togglePinWidget(widgetId, e)} className="text-[#2665fd] p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-lg" title="Unpin Widget">
          ...
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {(['AIDA', 'PAS', 'BAB'] as const).map((f) => (
                <button
                  ...
                  className={cn(
                    "px-4 py-3 rounded-xl text-xs font-bold transition-all border text-left flex flex-col",
                    framework === f 
                      ? "bg-purple-50 dark:bg-purple-500/10 border-purple-500 text-purple-700 dark:text-purple-400" 
                      : "bg-white dark:bg-[#1A1A1A] border-[#E9E9E7] dark:border-[#3E3E3E] text-[#787774] hover:bg-[#F7F7F5] dark:hover:bg-[#2E2E2E]"
                  )}
                >
            ...
            <input
              ...
              className="w-full bg-[#F7F7F5] dark:bg-[#2E2E2E] border border-[#E9E9E7] dark:border-[#3E3E3E] rounded-xl p-4 text-sm focus:border-purple-500 outline-none transition-all text-[#37352F] dark:text-[#EBE9ED]"
            />
            
            <button
              onClick={generateFrameworkCopy}
              disabled={isGeneratingFramework || !frameworkProduct}
              className="flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 bg-purple-600 hover:bg-purple-700 disabled:opacity-50 text-white rounded-xl text-sm font-bold transition-all active:scale-95"
            >
        ...
        <div key={widgetId} className="bg-white dark:bg-[#1A1A1A] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-2xl overflow-hidden flex flex-col mb-6">
          <div className="p-5 border-b border-[#E9E9E7] dark:border-[#2E2E2E] bg-[#F7F7F5] dark:bg-[#2E2E2E] flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#787774] dark:text-[#9B9A97]">Multi-platform generation</p>
              </div>
            </div>
            {activeWidget === null && (
              <button onClick={(e) => togglePinWidget(widgetId, e)} className="text-[#2665fd] p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-lg" title="Unpin Widget">
          ...
          <div className="p-6 space-y-6">
            <input
              ...
              className="w-full bg-[#F7F7F5] dark:bg-[#2E2E2E] border border-[#E9E9E7] dark:border-[#3E3E3E] rounded-xl p-4 text-sm focus:border-orange-500 outline-none transition-all text-[#37352F] dark:text-[#EBE9ED]"
            />
            
            <button
              onClick={handleGenerateCampaign}
              disabled={isGeneratingCampaign || !campaignUrl}
              className="flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-white rounded-xl text-sm font-bold transition-all active:scale-95"
            >
            ...
            {campaignResult && (
              <div className="mt-6 space-y-4">
                {campaignResult.twitterThread && (
                  <div className="bg-[#F7F7F5] dark:bg-[#2E2E2E] border border-[#E9E9E7] dark:border-[#3E3E3E] rounded-xl p-5">
                    <h4 className="text-[10px] font-bold text-[#787774] dark:text-[#9B9A97] uppercase tracking-widest mb-4 flex items-center gap-2">
                    ...
                    <div className="space-y-3">
                      {campaignResult.twitterThread.map((tweet: string, i: number) => (
                        <div key={i} className="text-sm text-[#37352F] dark:text-[#EBE9ED] bg-white dark:bg-[#1A1A1A] p-3 rounded-lg border border-[#E9E9E7] dark:border-[#3E3E3E]">
                          {tweet}
                        </div>
                      ))}
                    </div>
    ...
    if (widgetId === 'resizer') {
      return (
        <div key={widgetId} className="bg-white dark:bg-[#1A1A1A] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-2xl overflow-hidden shadow-sm mb-6 relative">
          {activeWidget === null && (
    ...
    if (widgetId === 'bulk') {
      return (
        <div key={widgetId} className="bg-white dark:bg-[#1A1A1A] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-2xl overflow-hidden flex flex-col mb-6">
          <div className="p-5 border-b border-[#E9E9E7] dark:border-[#2E2E2E] bg-[#F7F7F5] dark:bg-[#2E2E2E] flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#787774] dark:text-[#9B9A97]">Transform a topic into a week of content ideas instantly.</p>
              </div>
            </div>
            {activeWidget === null && (
              <button onClick={(e) => togglePinWidget(widgetId, e)} className="text-[#2665fd] p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-lg" title="Unpin Widget">
          ...
          <div className="p-6 space-y-6">
            <div className="bg-[#F7F7F5] dark:bg-[#202020] p-5 rounded-2xl border border-[#E9E9E7] dark:border-[#2E2E2E] space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-4">
                <div className="sm:col-span-8">
                  <label className="block text-[10px] font-black text-[#787774] uppercase tracking-widest mb-1.5 ml-1">Topic or Category</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-[#191919] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-xl pl-10 pr-4 py-3 text-sm focus:ring-2 focus:ring-emerald-500 outline-none transition-all"
                    />
                  </div>
                </div>
                <div className="sm:col-span-4">
                  <label className="block text-[10px] font-black text-[#787774] uppercase tracking-widest mb-1.5 ml-1">Post Count</label>
                  <select
                    value={bulkCount}
                    onChange={(e) => setBulkCount(Number(e.target.value))}
                    className="w-full bg-white dark:bg-[#191919] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-emerald-500 outline-none transition-all"
                  >
              ...
              <button
                ...
                className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20"
              >
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex items-center justify-between px-1">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#37352F] dark:bg-[#EBE9ED] text-white dark:text-[#191919] rounded-xl text-xs font-bold hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center gap-2 shadow-sm"
                  >
                      ...
                      >
                        ...
                        <div className="pr-8">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-wider text-[#787774] dark:text-[#9B9A97] bg-[#F7F7F5] dark:bg-[#2E2E2E] px-2 py-0.5 rounded">
                              {post.type}
                            </span>
                          </div>
                          ...
                          {post.brief && (
                            <p className="text-xs text-[#787774] dark:text-[#9B9A97] line-clamp-2 mb-2 italic">
                              Visual: {post.brief}
                            </p>
                          )}
                          {post.caption && (
                            <p className="text-xs text-[#787774] dark:text-[#9B9A97] line-clamp-2 mb-2">
                              {post.caption}
                            </p>
                          )}
          ...
          <div className="p-5 border-b border-[#E9E9E7] dark:border-[#2E2E2E] bg-[#F7F7F5] dark:bg-[#2E2E2E] flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#787774] dark:text-[#9B9A97]">{customWidget.description}</p>
              </div>
            </div>
            {activeWidget === null && (
              <button onClick={(e) => togglePinWidget(widgetId, e)} className="text-[#2665fd] p-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-lg" title="Unpin Widget">
          ...
          <div className="p-6 space-y-6">
            {vars.length > 0 ? (
              <div className="space-y-4">
                {vars.map(v => (
                  <div key={v}>
                    <label className="block text-xs font-black text-[#787774] dark:text-white/40 uppercase tracking-widest ml-1 mb-2">{v}</label>
                    <input
                      type="text"
        ...
        <div className="flex items-center justify-between p-6 bg-[#F7F7F5] dark:bg-[#202020] border-b border-[#E9E9E7] dark:border-[#2E2E2E]">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#787774] dark:text-white/40">Design and test your custom AI workflow</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <button 
              onClick={() => setIsPlaygroundOpen(false)} 
              className="px-6 py-2.5 text-sm font-bold text-[#787774] hover:text-[#37352F] dark:hover:text-white transition-colors"
            >
              Cancel
            </button>
            <button 
        ...
        <div className="flex flex-1 overflow-hidden flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-6 overflow-y-auto border-r border-[#E9E9E7] dark:border-[#2E2E2E] space-y-6">
            <div className="space-y-2">
              <label className="block text-xs font-black text-[#787774] dark:text-white/40 uppercase tracking-widest ml-1">Workflow Title</label>
              <input 
                type="text" 
                value={newWidgetTitle}
                onChange={(e) => setNewWidgetTitle(e.target.value)}
                placeholder="e.g., Viral Hook Generator"
                className="w-full p-4 bg-[#F7F7F5] dark:bg-white/5 border border-[#E9E9E7] dark:border-white/10 rounded-2xl text-sm outline-none focus:ring-2 focus:ring-[#2665fd] transition-all dark:text-white"
              />
            </div>
            <div className="space-y-2">
              <label className="block text-xs font-black text-[#787774] dark:text-white/40 uppercase tracking-widest ml-1">Description</label>
              <input 
                type="text" 
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between mb-1 ml-1">
                <label className="block text-xs font-black text-[#787774] dark:text-white/40 uppercase tracking-widest">Prompt Template</label>
                <button 
              ...
              <p className="text-[10px] text-[#787774] dark:text-white/30 mb-2 ml-1">Use <code className="bg-[#E9E9E7] dark:bg-white/10 px-1 rounded">{"{{variable_name}}"}</code> to create dynamic inputs.</p>
              <textarea 
          ...
          <div className="w-full md:w-1/2 p-6 overflow-y-auto bg-gray-50 dark:bg-[#151515]">
            ...
            <div className="space-y-6">
              {vars.length > 0 ? (
                <div className="space-y-4 bg-white dark:bg-[#202020] p-5 rounded-2xl border border-[#E9E9E7] dark:border-[#2E2E2E]">
                  <h5 className="text-xs font-bold text-[#787774] dark:text-white/40 uppercase tracking-widest mb-4">Variables Detected</h5>
                  {vars.map(v => (
                    <div key={v}>
                      <label className="block text-[10px] font-black text-[#787774] dark:text-white/40 uppercase tracking-widest ml-1 mb-1.5">{v}</label>
                      <input
                        type="text"
                        value={playgroundTestInputs[v] || ''}
                        onChange={(e) => setPlaygroundTestInputs(prev => ({ ...prev, [v]: e.target.value }))}
                        placeholder={`Test value for ${v}...`}
                        className="w-full p-3 bg-[#F7F7F5] dark:bg-[#151515] border border-[#E9E9E7] dark:border-[#3E3E3E] rounded-xl text-sm outline-none focus:border-emerald-500 transition-all text-[#37352F] dark:text-[#EBE9ED]"
                      />
                    </div>
                  ))}
                </div>
              ) : (
                <div className="text-sm text-amber-600 bg-amber-50 dark:bg-amber-500/10 dark:text-amber-400 p-4 rounded-xl border border-amber-200 dark:border-amber-500/20">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white rounded-xl text-sm font-bold transition-all shadow-lg shadow-emerald-500/20 active:scale-95"
              >
              ...
              {playgroundTestResult && (
                <div className="bg-white dark:bg-[#202020] border border-[#E9E9E7] dark:border-[#2E2E2E] rounded-2xl p-5 shadow-sm">
                  <h4 className="text-[10px] font-bold text-[#787774] dark:text-[#9B9A97] uppercase tracking-widest mb-4">Output</h4>
                  <div className="prose prose-sm dark:prose-invert max-w-none whitespace-pre-wrap text-sm leading-relaxed text-[#37352F] dark:text-[#EBE9ED]">
                    {playgroundTestResult}
                  </div>
                </div>
    ...
    return (
      <div className="flex flex-col bg-transparent pb-20 md:pb-0 h-full w-full">
        <button 
          ...
          className="flex items-center gap-2 text-sm font-bold text-[#787774] hover:text-[#37352F] dark:hover:text-[#EBE9ED] transition-colors mb-6 w-fit"
        >
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-base text-[#787774] dark:text-white/60 mt-2 max-w-md leading-relaxed">
              ...
              >
                <div className="absolute top-6 right-6 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all translate-y-[-10px] group-hover:translate-y-0">
                  ...
                  <button 
                    ...
                    className="p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-500/20 rounded-xl transition-all hover:scale-110"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
