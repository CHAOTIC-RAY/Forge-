...
export const BUILTIN_MODELS: BuiltInModel[] = [
  {
    ...
    size: '1.2GB',
    description:
      "Google Gemma 3 1B model optimized for LiteRT-LM. Best for mobile and speed.",
    recommendedRamGb: 4,
    estimatedVramGb: 1,
  ...
  },
  {
    ...
    size: '1.2GB',
    description:
      "Ultra-fast Gemma 4 model with Multi-Token Prediction. Best for mobile.",
    recommendedRamGb: 4,
    estimatedVramGb: 1,
    recommendedDatasetMin: 50,
    recommendedDatasetMax: 300,
  ...
  },
  {
    ...
    name: 'Phi-3 Mini 4K (LiteRT)',
    size: '2.3GB',
    description:
      "Microsoft Phi-3 Mini model optimized for efficiency and strong reasoning.",
    recommendedRamGb: 8,
    estimatedVramGb: 3,
  ...
  {
    id: 'llama-3.2-1b-web',
    name: 'Llama 3.2 1B (LiteRT)',
    size: '0.8GB',
    description:
      "Meta Llama 3.2 1B model for maximum efficiency on low-end devices.",
    recommendedRamGb: 4,
    estimatedVramGb: 1,
  ...
  // Legacy WebLLM models (keep for compatibility)
  {
    id: 'Llama-3.2-1B-Instruct-q4f16_1-MLC',
    name: 'Llama 3.2 1B Instruct (WebLLM)',
    size: '0.8GB',
    description:
  ...
  },
  {
    ...
    name: 'Phi-3 Mini Instruct (WebLLM)',
    size: '2.3GB',
    description:
